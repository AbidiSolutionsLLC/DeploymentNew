...
exports.updateTimeLog = catchAsync(async (req, res) => {
  const updatedTimeLog = await timeLogService.updateTimeLog(req.user, req.companyId, req.params.id, req.body, req.files);
...
exports.deleteTimeLog = catchAsync(async (req, res) => {
  await timeLogService.deleteTimeLog(req.user, req.companyId, req.params.id);
...
exports.downloadTimeLogAttachment = catchAsync(async (req, res) => {
  const url = await timeLogService.downloadTimeLogAttachment(req.user, req.companyId, req.params.id, req.params.attachmentId);
