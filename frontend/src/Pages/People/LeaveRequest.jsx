...
const ApplyLeaveModal = ({ isOpen, setIsOpen, onLeaveAdded }) => {
 ...
 return (
 <div className="fixed inset-0 bg-brand-bg/80 z-[100] flex justify-end">
 <div className="w-full sm:w-[450px] bg-surface h-full shadow-2xl flex flex-col animate-fade-left animate-duration-300">
 ...
 {/* FOOTER ACTIONS */}
 <div className="p-8 border-t border-border-subtle flex gap-4 bg-surface dark:bg-app">
 <button
 type="button"
 onClick={() => !isSubmitting && setIsOpen(false)}
 disabled={isSubmitting}
