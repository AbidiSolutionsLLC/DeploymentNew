...
const ViewTicketDetailsModal = ({ ticket: initialTicket, onClose }) => {
 ...
 return (
 <div className="fixed inset-0 bg-slate-900/40 z-[100] flex justify-center items-center p-4 sm:p-6" onClick={handleBackdropClick}>
 <div ref={modalRef} className="w-full max-w-2xl bg-surface rounded-[2rem] shadow-2xl relative flex flex-col max-h-[90vh] animate-fadeIn overflow-hidden">
 
 {/* Header */}
 <div className="px-6 py-5 border-b border-slate-50 flex justify-between items-center bg-surface z-10">
 <div>
