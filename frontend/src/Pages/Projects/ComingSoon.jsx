...
const ComingSoon = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center h-[60vh] bg-white/30 backdrop-blur-md rounded-2xl border border-white/60 shadow-sm text-center px-4">
