...
// className="my-4 w-full sm:min-w-[400px] max-w-md bg-surface p-6 sm:p-4 rounded-xl shadow-md"
...
// alt="user"
// className="w-16 h-16 rounded-full bg-surface p-1"
// />
// </div>
...
// onPaste={handlePaste}
// className="w-10 h-10 sm:w-12 sm:h-12 text-center text-xl border border-border-subtle rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400 bg-surface"
// />
// ))}
// </div>
