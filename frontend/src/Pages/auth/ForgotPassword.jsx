...
// className="w-full sm:min-w-[400px] max-w-md bg-surface p-6 sm:p-4 rounded-xl shadow-md"
// >
...
// <input
// type="email"
// className="w-full p-2 mb-2 rounded bg-gray-200 text-main focus:outline-none focus:ring-2 focus:ring-orange-400"
// {...register("email", {
