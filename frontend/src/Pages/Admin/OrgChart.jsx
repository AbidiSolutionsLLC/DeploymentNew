...
const OrgNode = ({ node, onNodeClick }) => {
 ...
 className="relative flex flex-col items-center w-full bg-surface rounded-xl shadow-md border border-border-subtle hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer overflow-hidden"
 >
 {/* Decorative Top Bar */}
 ...
 {/* Avatar */}
 <div className="w-16 h-16 mb-3 rounded-full p-1 bg-surface border border-border-subtle shadow-sm">
 <img
...
const OrgChartPage = () => {
 ...
 >
 {/* Chart Container */}
 <div className="bg-surface border border-border-subtle shadow-inner overflow-hidden relative rounded-2xl h-[calc(100vh-200px)] min-h-[500px]">
 <TransformWrapper
 initialScale={1}
 minScale={0.2}
 maxScale={2}
 ...
 <>
 {/* Zoom Controls */}
 <div className="absolute top-4 right-4 z-40 flex flex-col gap-2 bg-surface p-1.5 rounded-xl border border-border-subtle shadow-md">
 <button onClick={() => zoomIn()} className="p-2 hover:bg-app rounded-lg text-muted transition-colors" title="Zoom In">
 <FaSearchPlus size={16} />
 </button>
 <button onClick={() => resetTransform()} className="p-2 hover:bg-app rounded-lg text-muted transition-colors" title="Reset Zoom">
 <FaRedo size={14} />
 </button>
 <button onClick={() => zoomOut()} className="p-2 hover:bg-app rounded-lg text-muted transition-colors" title="Zoom Out">
 ...
 <div className="bg-app p-6 rounded-full mb-4">
 <FaUserTie className="text-4xl text-muted" />
 </div>
 <p className="font-semibold text-muted">No reporting hierarchy found.</p>
