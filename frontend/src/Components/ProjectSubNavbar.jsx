...
const SubNavbar = () => {
 ...
 <PhoneIcon className="w-5 h-5 text-muted hover:text-amber-500 cursor-pointer" />
 <CalendarDaysIcon className="w-5 h-5 text-muted hover:text-amber-500 cursor-pointer" />
 </div>
 </div>
 </MobileNav>
 </Navbar>
