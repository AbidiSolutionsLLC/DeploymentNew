...
const ExpenseForm = ({ onSubmitSuccess, onCancel }) => {
 ...
 : "bg-app text-muted hover:bg-slate-200"
 }`}
 >
 ...
 <div
 className={`border-2 border-dashed ${errors.receipt ? 'border-rose-300' : 'border-subtle'} bg-app/50 rounded-xl p-8 text-center hover:border-slate-400 hover:bg-app transition-all cursor-pointer group`}
 ...
 <div className="w-12 h-12 bg-surface rounded-xl border border-subtle flex items-center justify-center shadow-sm">
 ...
 <div className="w-16 h-16 bg-surface rounded-xl border border-subtle flex items-center justify-center mx-auto shadow-sm group-hover:scale-110 transition-transform">
 <Upload size={28} className="text-muted" />
 </div>
 <div>
 <p className="text-sm font-bold text-main">Click or drag {documentType}</p>
 ...
 className={`w-full bg-surface border ${errors.title ? 'border-red-400' : 'border-subtle'} rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-amber-100 outline-none transition-all text-main placeholder:text-slate-300`}
 ...
 <p className="text-[10px] text-muted uppercase tracking-widest">{formData.title.length}/100</p>
 </div>
 </div>
 ...
 onChange={handleChange}
 rows="4"
 className={`w-full bg-surface border ${errors.description ? 'border-red-400' : 'border-subtle'} rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-amber-100 outline-none transition-all text-main placeholder:text-slate-300 resize-none`}
 ...
 onChange={handleChange}
 className={`w-full bg-surface border ${errors.amount ? 'border-rose-400' : 'border-subtle'} rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-amber-100 outline-none transition-all text-main placeholder:text-slate-300`}
 placeholder="0.00"
 min="0"
 step="0.01"
 />
 ...
 <div className="border border-subtle bg-app/50 rounded-xl p-4 flex items-center gap-3">
 {preview ? (
 <img
 src={preview}
 alt="Receipt preview"
 ...
 <div className="w-16 h-16 bg-surface rounded-lg border border-subtle flex items-center justify-center shadow-sm">
 <FileText size={24} className="text-muted" />
 </div>
 )}
 <div className="flex-1 min-w-0">
 <p className="text-xs font-bold text-main truncate">{receipt?.name}</p>
