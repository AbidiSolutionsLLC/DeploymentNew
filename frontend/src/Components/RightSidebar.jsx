...
const RightSidebar = ({ isOpen, toggleSidebar }) => {
 ...
 <span className="text-[10px] font-bold text-muted uppercase tracking-wide mb-2">
 Current Session
 </span>
 <div className="flex items-center justify-center gap-1.5">
 <div className="bg-app text-main w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold shadow-inner">
 {elapsedTime.hours.toString().padStart(2, '0')}
 </div>
 <span className="text-main font-bold text-sm">:</span>
 <div className="bg-app text-main w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold shadow-inner">
 ...
 <p className="text-xs font-bold text-main truncate">{manager.name}</p>
 ...
 <UserCircleIcon className="w-6 h-6 text-muted" />
 </div>
 <div>
 <p className="text-xs font-medium text-muted italic">
 No manager assigned
 </p>
 <p className="text-[9px] text-muted">(You're the top level)</p>
 </div>
 </div>
 )}
 </div>
 ...
 <span className="text-[10px] bg-app px-1.5 py-0.5 rounded-full text-muted">
 {teamMembers.length}
 </span>
 </div>
 </div>
 ...
 className="flex items-center gap-1 hover:bg-app p-2 rounded-lg transition-colors cursor-pointer"
 >
 <Avatar url={member.avatar} name={member.name} />
 <div className="overflow-hidden flex-1">
 <p className="text-[10px] font-bold text-main truncate">
 {member.name}
 </p>
 <p className="text-[9px] text-muted truncate">
