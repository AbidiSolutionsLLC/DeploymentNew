  ...
  return (
    ...
    >
      <div className="space-y-6">
        {/* Title */}
        <div>
          <label className="block text-[10px] font-black text-muted dark:text-slate-500 mb-1 uppercase tracking-widest">
            TITLE
          </label>
        ...
        <div>
          ...
          <p className="text-sm text-muted dark:text-slate-400 leading-relaxed italic">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-3 bg-surface/50 dark:bg-slate-800/50 rounded-xl border border-border-subtle dark:border-slate-700">
            <label className="block text-[9px] font-black text-muted dark:text-slate-500 mb-1 uppercase tracking-widest">
              START DATE
            </label>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between border-b border-border-subtle dark:border-slate-700 pb-2">
            <span className="text-[10px] font-black text-muted dark:text-slate-500 uppercase tracking-widest">ASSIGNED TO</span>
            <span className="text-sm font-bold text-brand-primary">{task.assignee}</span>
          </div>
          <div className="flex items-center justify-between border-b border-border-subtle dark:border-slate-700 pb-2">
            <span className="text-[10px] font-black text-muted dark:text-slate-500 uppercase tracking-widest">ASSIGNED BY</span>
        ...
        <div className="flex gap-3">
          <div className="flex-1 flex flex-col items-center p-3 bg-surface/50 dark:bg-slate-800/50 rounded-2xl border border-dashed border-border-subtle dark:border-slate-700">
            <span className="text-[9px] font-black text-muted dark:text-slate-500 uppercase tracking-widest mb-1">PRIORITY</span>
          ...
          <div className="flex-1 flex flex-col items-center p-3 bg-surface/50 dark:bg-slate-800/50 rounded-2xl border border-dashed border-border-subtle dark:border-slate-700">
            <span className="text-[9px] font-black text-muted dark:text-slate-500 uppercase tracking-widest mb-1">STATUS</span>
