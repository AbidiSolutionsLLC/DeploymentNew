        ...
        <div className="flex flex-col lg:flex-row h-full">
          ...
          <div className="lg:w-1/2 lg:pl-6 flex flex-col min-h-[400px]">
            <h3 className="text-sm font-black text-heading dark:text-white uppercase tracking-widest mb-4 flex items-center gap-2">
              <FaComment className="text-muted dark:text-slate-400" />
              DISCUSSION
            </h3>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar mb-4 space-y-3 pr-2">
              {responses.length > 0 ? (
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start mb-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-muted dark:text-slate-400 uppercase">
                              {response.author?.role || response.role}
                            </span>
                            {response.isEdited && (
                              <span className="text-xs text-muted dark:text-slate-400 italic">(edited)</span>
                            )}
                          </div>
                          <div className="flex items-center gap-2">
                            ...
                            {!response.isSystemNote && isUserResponse(response) && (
                              <div className="flex gap-1">
                                <button
                                  ...
                                  className="p-1 text-muted dark:text-slate-400 hover:text-brand-primary transition"
                                  title="Edit"
                                >
                                  <Edit2 size={12} />
                                </button>
                                <button
                                  ...
                                  className="p-1 text-muted dark:text-slate-400 hover:text-red-600 transition"
                                  title="Delete"
                                >
                                  <Trash2 size={12} />
                                </button>
                        ...
                        {editingResponseId === response._id ? (
                          <div className="space-y-2">
                            <textarea
                              ...
                              rows="3"
                            />
                              <p className="text-[10px] text-muted dark:text-slate-400 text-right">
                ...
                <div className="text-center py-8">
                  <FaComment className="w-12 h-12 text-muted dark:text-slate-500 mx-auto mb-3 opacity-50" />
                  <p className="text-sm text-muted dark:text-slate-400 font-medium">No discussion yet</p>
                  <p className="text-xs text-muted dark:text-slate-500 mt-1">Start a conversation about this leave request</p>
                </div>
              )}
            </div>
            ...
            <div className="border-t border-border-subtle dark:border-slate-700 pt-4 mt-auto">
              <div className="relative">
                <textarea
                  ...
                  rows="3"
                />
                <p className="text-[10px] text-muted dark:text-slate-400 text-right mt-1">
                ...
                {/* Attachment Button */}
                <label className="absolute left-3 bottom-8 p-2 bg-surface/80 dark:bg-slate-800 text-muted dark:text-slate-400 rounded-lg hover:bg-surface dark:hover:bg-slate-700 transition cursor-pointer">
                  <input
                    type="file"
                    className="hidden"
              ...
              <p className="text-xs text-muted dark:text-slate-400 mt-2 px-1">
