...
const KanbanBoard = ({ tasks, onDragEnd, loading }) => {
 ...
 <div 
 className={`flex items-center justify-center h-32 text-sm rounded-lg border-2 border-dashed transition-all duration-200 border-primary/30 text-description ${draggedOver === column.id ? 'border-solid bg-secondary ' : ''}`}
 >
