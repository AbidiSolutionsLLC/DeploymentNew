        ...
        <div className="border-t border-border-subtle dark:border-slate-700 pt-6">
          ...
          <div className="space-y-4 mb-4 max-h-[300px] overflow-y-auto custom-scrollbar-visible pr-2">
            {timesheet.comments?.length > 0 ? (
              ...
              <p className="text-center text-xs text-muted dark:text-slate-500 italic py-4">No comments yet.</p>
            )}
          </div>
          ...
          <div className="relative">
            ...
            <div className="flex justify-between items-center mt-1 px-1">
              ...
              <p className="text-[10px] text-muted dark:text-slate-500 uppercase tracking-widest">{commentText.length}/200</p>
            </div>
            <button
