...
const ProjectDashboardCards = ({ donutData, barData }) => {
 ...
 <div className="bg-surface rounded-2xl shadow-md p-6 flex flex-col w-full">
 ...
 />
 <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-amber-700 font-bold text-xl">
